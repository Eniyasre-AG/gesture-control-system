...
class Controller:
    ...
    #     if isinstance(currentBrightnessLv, list):
    #         currentBrightnessLv = currentBrightnessLv[0]
    
    # # Normalize the brightness level
    #     currentBrightnessLv /= 100.0
    
    # # Adjust the brightness based on pinch level
    #     currentBrightnessLv += Controller.pinchlv / 50.0
    
    # # Clamp the brightness level between 0.0 and 1.0
    #     if currentBrightnessLv > 1.0:
    #         currentBrightnessLv = 1.0
    #     elif currentBrightnessLv < 0.0:
    #         currentBrightnessLv = 0.0
    
    # # Fade the brightness to the new level
    #     sbcontrol.fade_brightness(int(100 * currentBrightnessLv), start=int(sbcontrol.get_brightness(display=0)))
...
# gc1.start()
if _name_ == "_main_":
    # Initialize gesture controller and start it
